...
public class DashboardYearlyFragment extends Fragment {

    private static final String TAG = DashboardYearlyFragment.class.getSimpleName();
    ...
    private View mNavPevious;
    private View mNavNext;
    private TextView mChartNav;
    public int currentPage;
    public int totalPage;
    public int chartSize;

    // the labels that should be drawn on the XAxis
    final String[] quarters = new String[] { "jan", "feb", "mar", "apr", "mei", "jun", "jul", "agu", "sep", "okt", "nov", "des" };
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        startDate = now.dayOfYear().withMinimumValue();
        endDate   = now.dayOfYear().withMaximumValue();
        show      = "yearly";
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mFragmentView = inflater.inflate(R.layout.fragment_dashboard_yearly, container, false);
        ...
        mNavPevious = mFragmentView.findViewById(R.id.previous);
        mChartNav = (TextView) mFragmentView.findViewById(R.id.nav_page);
        mNavNext = mFragmentView.findViewById(R.id.next);
        ...
        call.enqueue(new TokenCallback<DashboardResponse>(mApi, mAccountPreference) {
            ...
            public void onResponse(Call<DashboardResponse> call, Response<DashboardResponse> response, boolean hasNewToken) {
                ...
                if (response.isSuccessful()) {
                    ...
                    totalPage   = entriesHarvest.size() <= 7 ? 1 : (int) Math.ceil((double) entriesHarvest.size() / 7);
                    currentPage = 1;
                    chartSize   = entriesHarvest.size();
                    mChartNav.setText(currentPage + "/" + totalPage);
                    ...
                    mNavPevious.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            ...
                            if (currentPage != 1) {
                                ...
                                mChart.moveViewTo((currentPage * 7) - 7, 50f, YAxis.AxisDependency.LEFT);
                                mChartNav.setText(currentPage + "/" + totalPage);
                            }
                        }
                    });
